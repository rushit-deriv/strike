...
const NinjaInlineIcon: React.FC<NinjaInlineIconProps> = ({ width = 64, height = 64, className, title = "Ninja Icon" }) => {
	return (
		<span className={className} style={{ color: "var(--strike-accent)" }}>
			<svg
				width={width}
				height={height}
...
export default NinjaInlineIcon
